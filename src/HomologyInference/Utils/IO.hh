...
std::vector<VH> read_landmarks_pinned(const fs::path& _path, const bool _throw_if_not_exist = true);
std::vector<VH> read_landmarks_vts(const fs::path& _path, const bool _throw_if_not_exist = true);
...
void write_landmarks_pinned(const std::vector<VH>& _landmarks, const fs::path& _path, const bool _overwrite = false);
void write_landmarks_vts(const std::vector<VH>& _landmarks, const fs::path& _path, const bool _overwrite = false);
